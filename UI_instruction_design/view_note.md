...
## 2. Tablet & Desktop
### 2.1. Sidebar
- Y hệt như trong "base.md"
### 2.2. Note view container
- Căn chính giữa (tính từ sidebar ra)
- Chia ra làm 2 phần
    - Bên trái: Note element để view
    - Bên phải: Reply note section
#### 2.2.1. Note element view
- Nằm bên trái màn hình của  người dùng
- Giống như phần note element view của mobile
#### 2.2.2. Reply note view
- Nằm bên phải màn hình của người dùng
- Giống như phần reply note của mobile
### 2.3. Top bar
- Giống phần mobile
