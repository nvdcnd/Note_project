...
@section('title', $organization->name.' - Noteket')
...
@section('mobile-fab')
    <button class="fab-add-btn btn btn-primary rounded-circle" id="fabBtn" onclick="toggleMobileCardSwap({ organizationId: {{ $organization->id }} })" title="Tạo Note Mới" style="position: fixed; bottom: 100px; right: 20px; width: 60px; height: 60px; font-size: 1.4rem; display: flex; align-items: center; justify-content: center; z-index: 2000;">
