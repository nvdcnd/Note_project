...
@section('content')
    <h2 class="text-center mb-4">Lịch sử giao dịch Người dùng ↔ Tổ chức</h2>

    <table class="table bg-white rounded shadow-sm">
        <thead>
            <tr><th>STT</th><th>Từ</th><th>Tổ chức</th><th>Số tiền</th><th>Trạng thái</th><th>Thời gian</th></tr>
        </thead>
        <tbody>
